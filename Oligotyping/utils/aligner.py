...
# Needleman-Wunsch alignment function (nw_align) and classes it uses
# included in this file was originally implemented in PyCogent library
# by Rob Knight and Jereny Widmann for The Cogent Project
